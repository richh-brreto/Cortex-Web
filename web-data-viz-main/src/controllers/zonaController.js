...
function posibilidadesModelo(req, res) {
  ...
  if (!fk_empresa) {
    ...
    zonaModel
      .posibilidadesModelo(fk_empresa)
      .then(function (resultado) {
        res.status(200).json(resultado);
      })
      .catch(function (erro) {
...
function posibilidadesArq(req, res) {
  ...
  if (!fk_empresa || !fk_zona) {
    ...
    zonaModel
      .posibilidadesArq(fk_empresa, fk_zona)
      .then(function (resultado) {
        res.status(200).json(resultado);
      })
      .catch(function (erro) {
...
function posibilidadesFunc(req, res) {
  ...
  if (!fk_empresa || !id_zona) {
    ...
    zonaModel
      .posibilidadesFunc(fk_empresa, id_zona)
      .then(function (resultado) {
        res.status(200).json(resultado);
      })
      .catch(function (erro) {
...
function vincularArquitetura(req, res) {
  ...
  if (!id_zona || !idArq || !qtdArq) {
    ...
    zonaModel
      .vincularArquitetura(idArq, id_zona, qtdArq)
      .then(function (resultado) {
        res.status(200).json(resultado);
      })
      .catch(function (erro) {
...
function vincularModelo(req, res) {
  ...
  if (!id_zona || !idModelo) {
    ...
    zonaModel
      .vincularModelo(idModelo, id_zona)
      .then(function (resultado) {
        res.status(200).json(resultado);
      })
      .catch(function (erro) {
...
function vincularFuncionario(req, res) {
  ...
  if (!idFunc || !id_zona) {
    ...
    zonaModel
      .vincularFuncionario(idFunc, id_zona)
      .then(function (resultado) {
        res.status(200).json(resultado);
      })
      .catch(function (erro) {
...
function desvincularArquitetura(req, res) {
  ...
  if (!id || !id_zona) {
    ...
    zonaModel
      .desvincularArquitetura(id, id_zona)
      .then(function (resultado) {
        res.status(200).json(resultado);
      })
      .catch(function (erro) {
...
function desvincularFuncionario(req, res) {
  ...
  if (!id || !id_zona) {
    ...
    zonaModel
      .desvincularFuncionario(id, id_zona)
      .then(function (resultado) {
        res.status(200).json(resultado);
      })
      .catch(function (erro) {
