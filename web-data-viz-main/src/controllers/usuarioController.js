...
function cadastrarEmpresa(req, res) {
  ...
  if (nomeEmpresa == undefined) {
    ...
    usuarioModel
      .cadastrarEmpresa(cnpj, nomeEmpresa, telefoneResponsavel, nomeResponsavel)
...
function cadastrarUsuario(req, res) {
  ...
  if (nome == undefined) {
    ...
    usuarioModel
      .cadastrarUsuario(idEmpresa, nome, email, senha, tel)
      .then(function (resultado) {
        res.json(resultado);
      })
      .catch(function (erro) {
  ...
  usuarioModel
    ...
    .then((resultado) => {
      if (resultado.length > 0) {
        ...
        const avatar =
          usuario.foto && String(usuario.foto).trim() !== ""
...
function alterarSenha(req, res) {
  ...
  usuarioModel
    .verificarSenha(idUsuario, senhaAtual)
    .then(function (resultado) {
      if (resultado.length == 0) {
      ...
      usuarioModel
        .alterarSenha(idUsuario, senhaNova)
