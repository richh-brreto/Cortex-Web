...
-- ============================================================
('Modelo_A1_01',150,'Carga inicial A1','10.0.1.1','host-a1-01',10,78,75,77,80,1,'proc_A1_01','2025-01-05',1,1),
('Modelo_A1_02',120,'Carga A1','10.0.1.2','host-a1-02',12,80,78,81,85,1,'proc_A1_02','2025-01-22',2,1),
('Modelo_A1_04',130,'A1 ajustado','10.0.1.4','host-a1-04',13,83,80,85,76,1,'proc_A1_04','2025-03-03',1,1),
('Modelo_A1_05',160,'A1 ganhos','10.0.1.5','host-a1-05',12,85,82,88,88,1,'proc_A1_05','2025-03-28',2,1),
('Modelo_A1_07',170,'A1 infra','10.0.1.7','host-a1-07',10,87,84,79,81,1,'proc_A1_07','2025-05-07',1,1),
('Modelo_A1_08',155,'A1 infra','10.0.1.8','host-a1-08',11,89,86,76,84,1,'proc_A1_08','2025-06-02',2,1),
('Modelo_A1_10',150,'A1 infra','10.0.1.10','host-a1-10',14,75,88,75,82,1,'proc_A1_10','2025-07-11',1,1),
('Modelo_A1_11',165,'A1 infra','10.0.1.11','host-a1-11',12,77,90,78,86,1,'proc_A1_11','2025-07-29',2,1),
('Modelo_A1_13',150,'A1 infra','10.0.1.13','host-a1-13',14,81,75,82,89,1,'proc_A1_13','2025-09-03',1,1),
('Modelo_A1_14',155,'A1 infra','10.0.1.14','host-a1-14',10,84,77,85,75,1,'proc_A1_14','2025-09-27',2,1),
('Modelo_A1_16',150,'A1 infra','10.0.1.16','host-a1-16',12,86,79,88,87,1,'proc_A1_16','2025-11-06',1,1),
('Modelo_A1_17',140,'A1 infra','10.0.1.17','host-a1-17',13,88,81,90,79,1,'proc_A1_17','2025-11-24',2,1),
('Modelo_A1_18',145,'A1 infra','10.0.1.18','host-a1-18',10,90,83,75,83,1,'proc_A1_18','2025-12-12',1,1),

-- ============================================================
-- ARQUITETURA 2 (18 registros) - levemente crescente
-- ============================================================
('Modelo_A2_01',140,'A2 base','10.0.2.1','host-a2-01',12,75,85,77,85,1,'proc_A2_01','2025-01-10',1,2),
('Modelo_A2_02',150,'A2 base','10.0.2.2','host-a2-02',11,77,87,80,78,1,'proc_A2_02','2025-01-30',2,2),
('Modelo_A2_03',130,'A2 base','10.0.2.3','host-a2-03',10,79,89,83,81,1,'proc_A2_03','2025-02-21',3,2),
('Modelo_A2_04',160,'A2','10.0.2.4','host-a2-04',10,81,75,86,84,1,'proc_A2_04','2025-03-05',1,2),
('Modelo_A2_05',155,'A2','10.0.2.5','host-a2-05',12,83,77,89,87,1,'proc_A2_05','2025-03-29',2,2),
('Modelo_A2_06',145,'A2','10.0.2.6','host-a2-06',12,85,79,75,90,1,'proc_A2_06','2025-04-15',3,2),
('Modelo_A2_07',135,'A2','10.0.2.7','host-a2-07',11,87,81,78,76,1,'proc_A2_07','2025-05-11',1,2),
('Modelo_A2_08',150,'A2','10.0.2.8','host-a2-08',15,89,83,81,79,1,'proc_A2_08','2025-06-07',2,2),
('Modelo_A2_09',165,'A2','10.0.2.9','host-a2-09',10,90,85,84,82,1,'proc_A2_09','2025-06-26',3,2),
('Modelo_A2_10',160,'A2','10.0.2.10','host-a2-10',10,76,87,87,85,1,'proc_A2_10','2025-07-21',1,2),
('Modelo_A2_11',150,'A2','10.0.2.11','host-a2-11',12,78,89,90,88,1,'proc_A2_11','2025-08-02',2,2),
('Modelo_A2_12',145,'A2','10.0.2.12','host-a2-12',14,80,90,75,75,1,'proc_A2_12','2025-08-27',3,2),
('Modelo_A2_13',150,'A2','10.0.2.13','host-a2-13',10,82,76,78,77,1,'proc_A2_13','2025-09-18',1,2),
('Modelo_A2_14',155,'A2','10.0.2.14','host-a2-14',11,84,78,81,80,1,'proc_A2_14','2025-10-04',2,2),
('Modelo_A2_15',165,'A2','10.0.2.15','host-a2-15',10,86,80,84,83,1,'proc_A2_15','2025-10-29',3,2),
('Modelo_A2_16',170,'A2','10.0.2.16','host-a2-16',13,88,82,87,86,1,'proc_A2_16','2025-11-15',1,2),
('Modelo_A2_17',150,'A2','10.0.2.17','host-a2-17',11,90,84,90,89,1,'proc_A2_17','2025-12-01',2,2),
('Modelo_A2_18',145,'A2','10.0.2.18','host-a2-18',10,75,86,76,75,1,'proc_A2_18','2025-12-20',1,2),

-- ============================================================
-- ARQUITETURA 3 (18 registros)
-- ============================================================
('Modelo_A3_01',130,'A3 base','10.0.3.1','host-a3-01',12,75,88,75,80,1,'proc_A3_01','2025-01-07',1,3),
('Modelo_A3_02',140,'A3 base','10.0.3.2','host-a3-02',10,77,90,78,85,1,'proc_A3_02','2025-01-26',2,3),
('Modelo_A3_03',135,'A3','10.0.3.3','host-a3-03',11,79,75,81,76,1,'proc_A3_03','2025-02-18',3,3),
('Modelo_A3_04',150,'A3','10.0.3.4','host-a3-04',10,81,77,84,88,1,'proc_A3_04','2025-03-09',1,3),
('Modelo_A3_05',155,'A3','10.0.3.5','host-a3-05',14,83,79,87,81,1,'proc_A3_05','2025-03-25',2,3),
('Modelo_A3_06',140,'A3','10.0.3.6','host-a3-06',15,85,81,90,84,1,'proc_A3_06','2025-04-19',3,3),
('Modelo_A3_07',150,'A3','10.0.3.7','host-a3-07',12,87,83,75,87,1,'proc_A3_07','2025-05-08',1,3),
('Modelo_A3_08',145,'A3','10.0.3.8','host-a3-08',14,89,85,78,90,1,'proc_A3_08','2025-06-05',2,3),
('Modelo_A3_09',160,'A3','10.0.3.9','host-a3-09',10,90,87,81,75,1,'proc_A3_09','2025-06-30',3,3),
('Modelo_A3_10',150,'A3','10.0.3.10','host-a3-10',12,76,89,84,78,1,'proc_A3_10','2025-07-16',1,3),
('Modelo_A3_11',155,'A3','10.0.3.11','host-a3-11',11,78,90,87,81,1,'proc_A3_11','2025-08-10',2,3),
('Modelo_A3_12',145,'A3','10.0.3.12','host-a3-12',13,80,76,90,84,1,'proc_A3_12','2025-08-30',3,3),
('Modelo_A3_13',165,'A3','10.0.3.13','host-a3-13',12,82,78,75,87,1,'proc_A3_13','2025-09-11',1,3),
('Modelo_A3_14',155,'A3','10.0.3.14','host-a3-14',14,84,80,78,90,1,'proc_A3_14','2025-09-24',2,3),
('Modelo_A3_15',160,'A3','10.0.3.15','host-a3-15',13,86,82,81,76,1,'proc_A3_15','2025-10-21',3,3),
('Modelo_A3_16',150,'A3','10.0.3.16','host-a3-16',12,88,84,84,79,1,'proc_A3_16','2025-11-02',1,3),
('Modelo_A3_17',145,'A3','10.0.3.17','host-a3-17',11,90,86,87,82,1,'proc_A3_17','2025-12-05',2,3),
('Modelo_A3_18',160,'A3','10.0.3.18','host-a3-18',10,75,88,90,85,1,'proc_A3_18','2025-12-22',1,3),

-- ============================================================
-- ARQUITETURA 4 (18 registros)
-- ============================================================
('Modelo_A4_01',160,'A4 base','10.0.4.1','host-a4-01',11,75,90,75,88,1,'proc_A4_01','2025-01-04',1,4),
('Modelo_A4_02',150,'A4 base','10.0.4.2','host-a4-02',12,77,75,78,90,1,'proc_A4_02','2025-01-25',2,4),
('Modelo_A4_03',140,'A4','10.0.4.3','host-a4-03',10,79,77,81,76,1,'proc_A4_03','2025-02-13',1,4),
('Modelo_A4_04',155,'A4','10.0.4.4','host-a4-04',13,81,79,84,79,1,'proc_A4_04','2025-03-02',2,4),
('Modelo_A4_05',160,'A4','10.0.4.5','host-a4-05',10,83,81,87,82,1,'proc_A4_05','2025-03-26',1,4),
('Modelo_A4_06',145,'A4','10.0.4.6','host-a4-06',10,85,83,90,85,1,'proc_A4_06','2025-04-21',2,4),
('Modelo_A4_07',165,'A4','10.0.4.7','host-a4-07',11,87,85,76,88,1,'proc_A4_07','2025-05-16',1,4),
('Modelo_A4_08',150,'A4','10.0.4.8','host-a4-08',12,89,87,79,90,1,'proc_A4_08','2025-06-03',2,4),
('Modelo_A4_09',155,'A4','10.0.4.9','host-a4-09',14,90,89,82,75,1,'proc_A4_09','2025-06-25',1,4),
('Modelo_A4_10',160,'A4','10.0.4.10','host-a4-10',10,76,90,85,78,1,'proc_A4_10','2025-07-14',2,4),
('Modelo_A4_11',170,'A4','10.0.4.11','host-a4-11',13,78,76,88,81,1,'proc_A4_11','2025-08-13',1,4),
('Modelo_A4_12',150,'A4','10.0.4.12','host-a4-12',12,80,78,90,84,1,'proc_A4_12','2025-08-31',2,4),
('Modelo_A4_13',160,'A4','10.0.4.13','host-a4-13',11,82,80,75,87,1,'proc_A4_13','2025-09-15',1,4),
('Modelo_A4_14',155,'A4','10.0.4.14','host-a4-14',14,84,82,78,90,1,'proc_A4_14','2025-10-11',2,4),
('Modelo_A4_15',165,'A4','10.0.4.15','host-a4-15',10,86,84,81,76,1,'proc_A4_15','2025-11-08',1,4),
('Modelo_A4_16',155,'A4','10.0.4.16','host-a4-16',12,88,86,84,79,1,'proc_A4_16','2025-11-30',2,4),
('Modelo_A4_17',150,'A4','10.0.4.17','host-a4-17',11,90,88,87,82,1,'proc_A4_17','2025-12-09',1,4),
('Modelo_A4_18',160,'A4','10.0.4.18','host-a4-18',10,75,90,90,85,1,'proc_A4_18','2025-12-28',1,4),

-- ============================================================
-- ARQUITETURA 5 (18 registros) - tendência decrescente
-- ============================================================
('Modelo_A5_01',200,'A5 top','10.0.5.1','host-a5-01',12,88,75,86,88,1,'proc_A5_01','2025-01-06',1,5),
('Modelo_A5_02',190,'A5','10.0.5.2','host-a5-02',10,86,77,84,85,1,'proc_A5_02','2025-01-28',1,5),
('Modelo_A5_03',185,'A5','10.0.5.3','host-a5-03',13,84,79,82,82,1,'proc_A5_03','2025-02-17',1,5),
('Modelo_A5_04',180,'A5','10.0.5.4','host-a5-04',11,82,81,80,79,1,'proc_A5_04','2025-03-08',1,5),
('Modelo_A5_05',175,'A5','10.0.5.5','host-a5-05',12,80,83,78,76,1,'proc_A5_05','2025-03-23',1,5),
('Modelo_A5_06',170,'A5','10.0.5.6','host-a5-06',12,78,85,76,89,1,'proc_A5_06','2025-04-20',1,5),
('Modelo_A5_07',165,'A5','10.0.5.7','host-a5-07',13,76,87,88,86,1,'proc_A5_07','2025-05-18',1,5),
('Modelo_A5_08',160,'A5','10.0.5.8','host-a5-08',12,90,89,85,83,1,'proc_A5_08','2025-06-09',1,5),
('Modelo_A5_09',158,'A5','10.0.5.9','host-a5-09',11,89,90,82,80,1,'proc_A5_09','2025-06-29',1,5),
('Modelo_A5_10',155,'A5','10.0.5.10','host-a5-10',14,87,76,79,77,1,'proc_A5_10','2025-07-17',1,5),
('Modelo_A5_11',152,'A5','10.0.5.11','host-a5-11',13,85,78,76,90,1,'proc_A5_11','2025-08-05',1,5),
('Modelo_A5_12',150,'A5','10.0.5.12','host-a5-12',11,83,80,88,87,1,'proc_A5_12','2025-08-27',1,5),
('Modelo_A5_13',148,'A5','10.0.5.13','host-a5-13',12,81,82,85,84,1,'proc_A5_13','2025-09-10',1,5),
('Modelo_A5_14',147,'A5','10.0.5.14','host-a5-14',15,79,84,82,81,1,'proc_A5_14','2025-10-01',1,5),
('Modelo_A5_15',145,'A5','10.0.5.15','host-a5-15',10,77,86,79,78,1,'proc_A5_15','2025-10-26',1,5),
('Modelo_A5_16',143,'A5','10.0.5.16','host-a5-16',11,75,88,76,75,1,'proc_A5_16','2025-11-20',1,5),
('Modelo_A5_17',140,'A5','10.0.5.17','host-a5-17',12,90,90,88,88,1,'proc_A5_17','2025-12-06',1,5),
('Modelo_A5_18',138,'A5','10.0.5.18','host-a5-18',13,88,75,85,85,1,'proc_A5_18','2025-12-23',1,5);
