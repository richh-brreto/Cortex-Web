...
const chatIA = new GoogleGenerativeAI(
  process.env.CHAVE_BOBIA || process.env.GEMINI_API_KEY
);
...
const infoModeloRouter = require("./src/routes/info-modelo");
const empresaDadosRouter = require("./src/routes/empresaDados");
const modelosRouter = require("./src/routes/modelos");
const adminRouter = require("./src/routes/admin");
const dashTecnicoRouter = require("./src/routes/dashTecnico");
//const clienteRouter = require("./src/routes/info-cliente");
const clienteRouter = require("./src/routes/cliente");
const funcionarioRouter = require("./src/routes/funcionario");
const zonaRouter = require("./src/routes/zona");
const arquiteturaRouter = require("./src/routes/arquiteturas");
const muralRoute = require("./src/routes/mural");
const dashInfraestruturaRoute = require("./src/routes/dashInfraestrutura");
const ticketsRoute = require("./src/routes/tickets");
const s3TicketRoute = require("./src/routes/s3Ticket");
const alertasRoute = require("./src/routes/alertas");
