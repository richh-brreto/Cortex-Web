...
const alertsChart = new Chart(alertsCtx, {
  ...
  '01/11/2025', '02/11/2025', '03/11/2025', '04/11/2025'
        ...
        datasets: [{
            label: 'Alertas - CPU',
            data: [12, 9, 15, 10, 18, 5, 2, 3, 5, 3, 3, 1, 1, 3, 8, 3, 4,7, 3, 3, 7, 3, 1, 2, 3,0,0, 1,1,15,11],
            borderColor: '#00B2B2',
...
function atualizarGrafico(tipo, botao) {
    const dadosMock = {
        CPU: [12, 9, 15, 10, 18, 5, 2, 3, 5, 3, 3, 1, 1, 3, 8, 3, 4,7, 3, 3, 7, 3, 1, 2, 3,0,0, 1,1,15,11],
        RAM: [12, 9, 15, 10, 18, 5, 2, 24, 5, 3, 3, 1, 1, 3, 8, 2, 4,7, 3, 3, 17, 3, 1, 12, 3,0,10, 1,11,1,2],
        DISCO: [12, 9, 15, 10, 18, 0, 2, 3, 5, 20, 3, 1, 1, 8, 8, 3, 4,7, 3, 3, 7, 3, 1, 2, 3,0,0, 5,1,1,14],
        GPU: [12, 9, 15, 10, 18, 5, 2, 3, 13, 3, 3, 1, 1, 3, 8, 3, 4,7, 23, 3, 7, 3, 1, 2, 3,0,0, 6,1,1,7]
    };
